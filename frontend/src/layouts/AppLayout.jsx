  ...
  return (
    <header className="flex h-[72px] items-center justify-between px-4 sm:px-6 fixed top-0 left-0 right-0 z-[1000] bg-white dark:bg-[#0F172A] border-b border-slate-200 dark:border-slate-800/80 gap-2 transition-colors duration-200">
      ...
      <form
        ...
        className="flex items-center w-full max-w-[180px] xs:max-w-[260px] sm:max-w-[420px] bg-slate-50 dark:bg-slate-800/80 border border-slate-800 dark:border-slate-700 hover:border-slate-900 dark:hover:border-slate-500 focus-within:border-slate-900 dark:focus-within:border-cyan-500 focus-within:ring-2 focus-within:ring-slate-200 dark:focus-within:ring-cyan-500/20 rounded-full px-3 sm:px-4 py-2 transition-all select-none mx-1 sm:mx-2"
      >
        <button
          type="submit"
